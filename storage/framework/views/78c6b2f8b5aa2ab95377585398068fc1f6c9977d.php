    ...
    <main class="main-container">
        <?php if(session()->has('message')): ?>
            <div class="alert alert-danger">
                <li class="message"><?php echo e(session()->get('message')); ?></li>
            </div>
        <?php endif; ?>
        <!-- CONTAINER ALL -->
        <div class="single-product-box">
            <?php $__currentLoopData = $SingleProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="product-img">
                    <div class="big-img">
                        <img id="img" src="<?php echo e(asset('assets/image/ProductImg/' . $Product->product_img)); ?>">
                    </div>

                    <div class="small-box">
                        <?php $__currentLoopData = $productsImgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productsImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="small-img">
                                <img src="<?php echo e(asset('assets/image/ProductImg/' . $productsImg->productImg)); ?>"
                ...
                <div class="product-details">
                    ...
                    <span class="product-desc"><?php echo e($Product->product_short_desc); ?></span>
                    ...
                    <div class="stock text">
                        <span>Stock:(<?php echo e($Product->quantity); ?>)</span>
                    </div>
                    ...
                    <?php if($Product->quantity > 0): ?>
                        <div class="button">
                            <form action="<?php echo e(route('buynow.products')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="SingleProducts[productsId]" value="<?php echo e($Product['id']); ?>">
                            ...
                            <form action="<?php echo e(route('addtocart.products')); ?>" method="post">
                                <?php echo csrf_field(); ?>
        ...
        <div class="product-all-details">
            <div class="product-titel">
                <span><?php echo e($Product->product_short_desc); ?></span>
            </div>

            <div class="Description-details">
                <span>Description.....</span>
                <p><?php echo e($Product->product_long_desc); ?>
            ...
            <div class="button">
                <form action="<?php echo e(route('buynow.products')); ?>" method="post">
                    ...
                    <div class="button-buyNow">
                        ...
                        <input type="hidden" name="SingleProducts[productsImg]"
                            value="<?php echo e($Product['product_img']); ?>">
                        <input type="hidden" name="SingleProducts[name]" value="<?php echo e($Product['product_name']); ?>">
                        <input type="hidden" name="SingleProducts[price]" value="<?php echo e($Product['product_price']); ?>">
...
<?php /**PATH C:\Users\ADMIN\Desktop\e-commarce\resources\views/single-product.blade.php ENDPATH**/ ?>