    ...
    <div class="main-container">
        ...
        <div class="filter-container">
            <div class="filter-content">
                <ul class="category">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('category.product', ['id' => $category->id, 'slug' => $category->slug])); ?>">
                            <li><span><?php echo e($category->category_name); ?></span></li>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>

                <form action="<?php echo e(route('PriceFiltur')); ?>" method="get">
                    <ul>
                ...
                <form action="<?php echo e(route('SizeFiltur')); ?>" method="get">
                    <ul>
            ...
            <div class="product-content">
                <div class="filter-box">
                    <?php if(isset($categorySlugs)): ?>
                        <?php $__currentLoopData = $categorySlugs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h1> <?php echo e($slug->slug); ?></h1>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <?php $__currentLoopData = $categoriesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h1><?php echo e($category['categorySlug']); ?></h1>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <div class="sort-content">
                        <div class="result-bar">
                            ...
                            <?php if(isset($categorySlugs)): ?>
                                <?php $__currentLoopData = $categorySlugs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span>
                                        <?php echo e($slug->slug); ?>

                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                                <?php $__currentLoopData = $categoriesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span><?php echo e($category['categorySlug']); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </div>
                            ...
                            <div class="dropdown-bar  Click-Category">
                                <div class="select-bar">
                                    <span class="selected">
                                        <?php if(isset($categorySlugs)): ?>
                                            <?php $__currentLoopData = $categorySlugs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span> <?php echo e($slug->slug); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $categoriesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span><?php echo e($category['categorySlug']); ?></span>
                ...
                <div class="product-container">
                    <?php if(isset($error)): ?>
                        <div class="massage">
                            <span><?php echo e($error); ?> Not available products</span>
                        </div>
                    <?php else: ?>
                        <div class="type">
                        ...
                        <div class="card product-card">
                            <?php $__currentLoopData = $priceProducts ?? ($products ?? $productSizes); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a
...
<?php /**PATH C:\Users\ADMIN\Desktop\e-commarce\resources\views/filter-product.blade.php ENDPATH**/ ?>