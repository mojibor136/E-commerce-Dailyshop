...
<style>
    * {
    ...
    .search-container .search .dropdown-bar {
        box-sizing: border-box;
        background: #afc0d1;
        cursor: pointer;
    }

    .search-container .search.dropdown-bar:hover {
        background: #e9ecef;
    }

    .search-container .search .dropdown-bar .select-bar {
        display: flex;
        align-items: center;
        color: #41464b;
        background-color: transparent;
    ...
    .search-container .search .dropdown-bar .caret {
...
<body>
    ...
    <script>
        let dropdownBtn = document.querySelector('.dropdown-bar');
...
<?php /**PATH C:\Users\ADMIN\Desktop\e-commarce\resources\views/test/test.blade.php ENDPATH**/ ?>